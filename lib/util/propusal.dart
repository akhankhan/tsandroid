...
class Content {
  ...
  factory Content.fromMap(Map<String, dynamic> json) => Content(
        pDetails:
            List<PDetail>.from(json["pDetails"].map((x) => PDetail.fromMap(x))),
      );
...
class PDetail {
  ...
  factory PDetail.fromMap(Map<String, dynamic> json) => PDetail(
        ...
        pPackages: List<PPackage>.from(
            json["pPackages"].map((x) => PPackage.fromMap(x))),
        ...
        sellersProposals: List<SellersProposal>.from(
            json["sellers_proposals"].map((x) => SellersProposal.fromMap(x))),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        "sellers_proposals":
            List<dynamic>.from(sellersProposals!.map((x) => x.toMap())),
      };
}
...
class Review {
  ...
  factory Review.fromMap(Map<String, dynamic> json) => Review(
        ...
        sellerReview:
            json["seller_review"] == null ? null : json["seller_review"],
        sellerRating:
            json["seller_rating"] == null ? null : json["seller_rating"],
      );
...
class Seller {
  ...
  factory Seller.fromMap(Map<String, dynamic> json) => Seller(
        ...
        sellerLanguages:
            List<dynamic>.from(json["seller_languages"].map((x) => x)),
      );
