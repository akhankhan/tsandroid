...
class _postarequestState extends State<postarequest> {
  ...
  save() async {
    ...
    print(dropdownValue);
    print(datacurrenct);
      final uri = Uri.parse(baseurl + version + postrequest);
  ...
  final uri = Uri.parse(baseurl + version + categorylink);
  ...
  Future<Null> getDatadate() async {
      final uri = Uri.parse(baseurl + version + deliverapidate);
  ...
  Future<Null> getDatas() async {
    ...
    final value = '1';
      final uri = Uri.parse(baseurl + version +  subcatlink +value);

      final responseDatas = await http.get(uri );
      final datas = responseDatas.body;
      ...
      setState(() {
        ...
        final uri = Uri.parse(baseurl+version+subcatlink + _mySelection!);
                                  ...
                                  child: new DropdownButton(
                                    ...
                                    items: datarime.map((item) {
                                      return new DropdownMenuItem(
                                        ...
                                        child: new Text(item.deliveryProposalTitle.toString()),
                                ...
                                child:    Row(
                                  children: <Widget>[
                                    Container(
                                      ...
                                      child:Text(datacurrenct.toString() ,style: TextStyle(
    color: Colors.black,
    fontSize: 18,
    fontWeight: FontWeight.w300,
    ),),
