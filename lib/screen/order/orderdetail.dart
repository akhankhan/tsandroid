...
class _orderpageState extends State<orderpage> {
  ...
  Future<Null> getData() async {
    ...
    print(baseurl + version  + orderdetails);
      final uri = Uri.parse(baseurl + version + orderdetails);
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          ): Container(child: Center(child: Text(listorder[0].postTitle.toString()))),
        ),
        body: loading
            ...
            ListView.builder(
                ...
                itemBuilder: (context, i) {
                  ...
                  return Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        Center(child: Text(datacard.postTitle.toString(),style: TextStyle(
                          color: primarycolor,
                            ...
                            children: <Widget>[
                              ...
                              Row(
                                children: <Widget>[
                                  ...
                                  Text(datacard.sellerName.toString(),style: TextStyle(
                                    color: Colors.black,
                                  ...
                                  Container(
                                      ...
                                      child: Row(
                                        children: <Widget>[
                                          ...
                                          Text("#" + datacard.orderNumber.toString(),style: TextStyle(
                                            color: Colors.black,
                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        Container(
                                            ...
                                            child: Center(child: Text(datacard.postTitle.toString(),style: TextStyle(
                                              color: Colors.black,
                                        ...
                                        Container(
                                            padding:EdgeInsets.only(top:5,bottom: 5),
                                            width: MediaQuery.of(context).size.width/4.6,
                                            child: Center(child: Text(datacard.orderDuration.toString(),style: TextStyle(
                                              color: Colors.black,
                                        ...
                                        Container(
                                            padding:EdgeInsets.only(top:5,bottom: 5),
                                            width: MediaQuery.of(context).size.width/4.6,
                                            child: Center(child: Text(datacard.itemPrice.toString(),style: TextStyle(
                                              color: Colors.black,
                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Container(
                                            padding:EdgeInsets.only(top:5,bottom: 5),
                                            width: MediaQuery.of(context).size.width/4.6,
                                            child: Center(child: Text(datacard.orderFee.toString(),style: TextStyle(
                                              color: Colors.black,
                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Container(
                                            padding:EdgeInsets.only(top:5,bottom: 5),
                                            width: MediaQuery.of(context).size.width/4.6,
                                            child: Center(child: Text(datacard.orderPrice.toString(),style: TextStyle(
                                              color: Colors.black,
                                      ...
                                      Row (
                                          children: <Widget>[
                                            Container(
                                              ...
                                              child: Text(listcat.senderName.toString(),  style: TextStyle(
                                                color: Colors.black,
                                                fontSize: 16,
                                              ),),),
                                            Container(
                                                child: Text(listcat.dateTime.toString() ,  style: TextStyle(
                                                  color: Colors.grey,
                                                  fontSize: 14,
                                                ),)),
                                          ]),
                                      Text(listcat.message.toString() ,  style: TextStyle(
                                        color: Colors.black,
                                        fontSize: 16,
                                      ),),
