...
class _InboxpageState extends State<Inboxpage> {
  ...
  Future<Null> getData(String choice) async {
    ...
    print(choice);
    if (choice == null) {
        final uri = Uri.parse(baseurl + version + inboxbox);
  ...
  final uri = Uri.parse(baseurl + version + actionlink);
                                    ...
                                    decoration: new BoxDecoration(
                                        ...
                                        image: new DecorationImage(
                                            ...
                                            image: new NetworkImage(
                                                nDataList.senderImage.toString())
                                        )
                                    ),
                                      child: new Stack(
                                        children: <Widget>[
                                                ...
                                                children: <Widget>[
                                                  Container(
                                                    width: MediaQuery
                                                        ...
                                                        .width / 1.8,
                                                    child: Text(
                                                      nDataList.senderMessage.toString(),
                                                      style: TextStyle(
                                                          fontWeight: FontWeight.w400,
                                                          color: Colors.black54,
                                                          fontSize: 15.5),
