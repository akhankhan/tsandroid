...
class _NotificationspageState extends State<Notifications> {
  ...
  Future<Null> getData(String choice) async {
    ...
    if(choice==null) {
        final uri = Uri.parse(baseurl + version + notificationlink);
  ...
  final uri = Uri.parse(baseurl + version + notificationactionlink);
      ...
      return Scaffold(
        ...
        body:  loading ? Center(child: CircularProgressIndicator(valueColor: new AlwaysStoppedAnimation<Color>(primarycolor)))
            ...
            itemBuilder: (context, i) {
              ...
              String fName =  nDataList.onlineStatus.toString();
print(fName);
              return Dismissible(
