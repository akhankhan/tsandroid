            ...
            onPressed: () => Navigator.pushReplacement(
              ...
              MaterialPageRoute(
                builder: (BuildContext context) =>
                    subcatDetails(widget.prelink, widget.pretitle),
              ),
            ),
          )
        : Container()),  // Wrap the true condition in a Container
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: NetworkImage(
                                nplacesList.postImage.toString(),
                              ),
                              fit: BoxFit.cover,
                            ),
                          ),
                                      ...
                                      children: <Widget>[
                                        ...
                                        Container(
                                          ...
                                          child: nplacesList.title!.length >=50 ? Text(
                                            ...
                                            nplacesList.title.toString(),style: TextStyle(
                                            color: Colors.black,
                                            fontSize: 14,
