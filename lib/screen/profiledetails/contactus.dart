...
class contactdetailpage extends StatefulWidget {
  ...
  contactdetailpage(this.messagegropid, this.sellname, {Key? key})
      : super(key: key);
  @override
...
class _contactdetailpageState extends State<contactdetailpage> {
  ...
  Future<Null> getData() async {
    ...
    final uri = Uri.parse(baseurl + version + contactuspage);

    final responseData = await http.post(uri,
        body: {'receiver_id': widget.messagegropid}, headers: {'Auth': token});
  ...
  Widget build(BuildContext context) {
    switch (_loginStatus) {
      ...
      case LoginStatus.messagesend:
        if (friendsList != null) {
          return Inboxdetailpage(friendsList!, widget.sellname);
        }
        break;
    }
    return Container();
