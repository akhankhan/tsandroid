...
class cartPage extends State<cart> {
  ...
  addquenty(String productid, String count) async {
    ...
    print(token);
    print(productid);
      final uri = Uri.parse(baseurl + version + changecart);
  ...
  delete(String productid) async {
    ...
    print(token);
    print(productid);
      final uri = Uri.parse(baseurl + version + removecart);
  ...
  final uri = Uri.parse(baseurl + version + cartpagelink);

    final responseData = await http
        .get(uri, headers: {'Auth': token});
                                        ...
                                        Row(
                                          children: <Widget>[
                                            ...
                                            new IconButton(
                                                ...
                                                onPressed: () =>
                                                    setState(() {
                                                      String value = (int.parse(datacart[index].proposalQuantity.toString())+1).toString();
                  ...
                  children: <Widget>[
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          directcontent[0].subTotalPrice.toString(),
                          style: TextStyle(
                              color: Colors.grey.shade700, fontSize: 16.0),
                        ),
                      ],),
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          directcontent[0].processingFee.toString(),
                          style: TextStyle(
                              color: Colors.grey.shade700, fontSize: 16.0),
                        ),
                      ],),
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          directcontent[0].totalPrice.toString(),
                          style: TextStyle(
                              color: Colors.grey.shade700, fontSize: 16.0),
                        ),
                      ],),
                        ...
                        child: MaterialButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => checkout( directcontent[0].paymentUrl.toString(), token)),
                              );
                            }))
                  ],
                ),
