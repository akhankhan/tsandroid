...
class _manageorderState extends State<manageorder> {
  ...
  Future<Null> getListViewItems(String items) async{
    ...
    print(items);
    print(token);
      final uri = Uri.parse(baseurl + version + manage);
                                                  ...
                                                  Row(
                                                    ...
                                                    children: <Widget>[
                                                      Container(
                                                          ...
                                                          margin:  EdgeInsets.only(left: 10, top: 8.00),
                                                          child: Text(datacard2.sellerName.toString(),style: TextStyle(
                                                            color: Colors.black,
                                                      ...
                                                      Container(
                                                          ...
                                                          margin:  EdgeInsets.only(left: 10, top: 8.00),
                                                          child: Text(datacard2.orderDate.toString(),style: TextStyle(
                                                            color: Colors.grey,
                                                  ...
                                                  Row(
                                                    ...
                                                    children: <Widget>[
                                                      Container(
                                                          ...
                                                          child: Text(datacard2.postTitle.toString(),style: TextStyle(
                                                            color: Colors.black,
                                                  ...
                                                  Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Container(
                                                          ...
                                                          child: Text(datacard2.orderPrice.toString(),style: TextStyle(
                                                            color: primarycolor,
                                                ...
                                                children: <Widget>[
                                                  Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Container(
                                                          width: MediaQuery.of(context).size.width/2.8,
                                                          margin:  EdgeInsets.only(left: 10, top: 8.00),
                                                          child: Text(datacard.orderDate.toString(),style: TextStyle(
                                                            color: Colors.grey,
                                                  ...
                                                  Row(
                                                    ...
                                                    children: <Widget>[
                                                      Container(
                                                          ...
                                                          width: MediaQuery.of(context).size.width/1.6,
                                                          margin:  EdgeInsets.only(left: 10, top: 0.00),
                                                          child: Text(datacard.postTitle.toString(),style: TextStyle(
                                                            color: Colors.black,
                                                            fontWeight: FontWeight.w300,
                                                            fontSize: 16,
                                                          ),textAlign: TextAlign.left,)),
                                                  ...
                                                  Row(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Container(
                                                          width: MediaQuery.of(context).size.width/7,
                                                          child: Text(datacard.orderPrice.toString(),style: TextStyle(
                                                            color: primarycolor,
