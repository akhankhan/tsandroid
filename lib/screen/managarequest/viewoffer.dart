...
class _viewofferState extends State<viewoffer> {
  ...
  Future<Null> getData() async {
    ...
    print(baseurl + version  + manage);
      final uri = Uri.parse(baseurl + version + viewofferlink);
                                            ...
                                            Row(
                                              ...
                                              children: <Widget>[
                                                Container(
                                                    width: MediaQuery.of(context).size.width/1.2,
                                                    margin:  EdgeInsets.only(left: 10, top: 8.00,bottom: 8),
                                                    child: Text(datacard2.requestTitle.toString())),
                                            ...
                                            Row(
                                              ...
                                              children: <Widget>[
                                                Container(
                                                    ...
                                                    width: MediaQuery.of(context).size.width/1.2,
                                                    child: Text("Request Budget: "+datacard2.requestBudget.toString())),
                                              ],
                                            ),
                                            Row(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: <Widget>[
                                                Container(
                                                    margin:  EdgeInsets.only(bottom: 8),
                                                    width: MediaQuery.of(context).size.width/1.2,
                                                    child: Text("Request Date: "+datacard2.requestDate.toString())),
                                              ],
                                            ),
                                            Row(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: <Widget>[
                                                Container(
                                                    margin:  EdgeInsets.only(bottom: 8),
                                                    width: MediaQuery.of(context).size.width/1.2,
                                                    child: Text("Request Duration: "+datacard2.requestDuration.toString())),
                                              ],
                                            ),
                                            Row(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: <Widget>[
                                                Container(
                                                    margin:  EdgeInsets.only(bottom: 8),
                                                    width: MediaQuery.of(context).size.width/1.2,
                                                    child: Text("Request Category: "+datacard2.requestCategory.toString())),
                                              ],
                                            ),
                                  ...
                                  Container(
                                    width: MediaQuery.of(context).size.width/1.2,
                                     height: MediaQuery.of(context).size.height/5,
                                      decoration: BoxDecoration(
                                          image: DecorationImage(image: NetworkImage(datacard2.offerImage.toString()),
                                              fit: BoxFit.cover)
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  Container(
                                                      ...
                                                      width: MediaQuery.of(context).size.width/1.2,
                                                      margin:  EdgeInsets.only(left: 10, top: 8.00,bottom: 8),
                                                      child: Text(datacard2.offerTitle.toString())),
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  Container(
                                                      margin:  EdgeInsets.only(bottom: 8),
                                                      width: MediaQuery.of(context).size.width/1.2,
                                                      child: Text(datacard2.offerDescription.toString())),
                                                ],
                                              ),
                                              Row(
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: <Widget>[
                                                  Container(
                                                      margin:  EdgeInsets.only(bottom: 8),
                                                      width: MediaQuery.of(context).size.width/1.2,
                                                      child: Text("Offer Budget: "+datacard2.offerBudget.toString())),
                                                ],
                                              ),
                                              Row(
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: <Widget>[
                                                  Container(
                                                      margin:  EdgeInsets.only(bottom: 8),
                                                      width: MediaQuery.of(context).size.width/1.2,
                                                      child: Text("Offer Duration: "+datacard2.offerDuration.toString())),
                                                ],
                                              ),
