...
class _manageeqState extends State<manageeq> {
  ...
  Future<Null> getListViewItems(String items) async{
    ...
    setState(() {
      ...
      final uri = Uri.parse(baseurl + version + manrequestlink);
...
print(listdeafult);
  ...
  active(String requestId, String valuest) async {
    ...
    print(baseurl + version  + manage);
      final uri = Uri.parse(baseurl + version + requestlink);
                                                  ...
                                                  Row(
                                                    ...
                                                    children: <Widget>[
                                                      Container(
                                                          ...
                                                          child: Text(datacard2.requestDate.toString())),
                                                      Container(
                                                  ...
                                                  Row(
                                                    ...
                                                    children: <Widget>[
                                                      Container(
                                                          width: MediaQuery.of(context).size.width/2.5,
                                                          margin:  EdgeInsets.only(left: 10, top: 8.00,bottom: 8),
                                                          child: Text(datacard.requestDate.toString())),
                                                      Container(
                                                  ...
                                                  Row(
                                                    ...
                                                    children: <Widget>[
                                                      Container(
                                                          ...
                                                          margin:  EdgeInsets.only(bottom: 8),
                                                          width: MediaQuery.of(context).size.width/1.2,
                                                          child: Text(datacard.requestDescription.toString())),
                                                    ],
                                                  ),
                                                      ...
                                                      Container(
                                                          ...
                                                          child:  Row(
                                                              ...
                                                              children: <Widget>[
                                                                ...
                                                                Text(datacard.deliveryDuration.toString(),style: TextStyle(
                                                                  color: Colors.black,
