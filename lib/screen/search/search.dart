...
class _searchState extends State<search> {
  ...
  onSearchTextChanged(String text) async {
    ...
    print(text);
    final uri = Uri.parse(baseurl + version + searchurl);

    final responseData = await http.post(uri, body: {
      "search_string": text,
    });
            ...
            child: Card(
              ...
              child: Container(
                ...
                child: Column(children: <Widget>[
                          ...
                          children: <Widget>[
                            ...
                            new Container(
                                ...
                                child: Column(
                                    ...
                                    children: <Widget>[
                                      Text(nplacesList.sellerName.toString()),
                                      Text(nplacesList.sellerLevel.toString()),
                                    ])),
                          ],
                        ),
                      ],
                  ...
                  Container(
                    padding:
                        EdgeInsets.only(right: 10.00, left: 10.00, top: 10.00),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                        Row(
                  ...
                  children: <Widget>[
                    Flexible(
                      child: Padding(
                        ...
                        child: Text(recent.description.toString()),
                      ),
                    ),
                  ],
                ),
